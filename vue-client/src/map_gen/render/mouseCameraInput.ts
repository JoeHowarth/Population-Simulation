...
import {PointerInfo, PointerEventTypes,
  FreeCamera,ICameraInput, CameraInputTypes,
  Nullable, serialize, Observer, EventState, Observable}
  from 'babylonjs'
...
(<any>CameraInputTypes)["OrthoCameraMouseInput"] = OrthoCameraMouseInput;
